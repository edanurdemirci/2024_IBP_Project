...
<header class="main-header">
      <div class="container container--flex">
        <div class="main-header__container">
          ...
          <nav class="main-nav" id="main-nav">
            <ul class="menu">
              ...
              <li class="menu__item"><a href="{{route('registration')}}" class="menu__link">Kayıt Ol</a></li>
              <li class="menu__item"><a href="{{route('login')}}" class="menu__link">Oturum Aç</a></li>
              <li class="menu__item"><a href="" class="menu__link"></a></li>
            </ul>
          </nav>
        </div>
        ...
        <div class="main-header__container">
          <a href="{{route('login')}}" class="main-header__link"><i class="fas fa-user"></i></a>
        </div>
      </div>
    </header>
      ...
      <div class="slider" id="slider">
        <div class="slider__section">
          ...
          <div class="slider__content">
            ...
            <a href="{{route('login')}}" class="btn-shop">Oturum Aç</a>
          </div>
        </div>
        <div class="slider__section">
    ...
    <footer class="main-footer">
      ...
      <div class="footer__section">
        ...
        <a href="{{route('home')}}" class="footer__link">Ana Sayfa</a>
        <a href="{{route('registration')}}" class="footer__link">Kayıt Ol</a>
        <a href="{{route('login')}}" class="footer__link">Oturum Aç</a>
      </div>
      <div class="footer__section">
