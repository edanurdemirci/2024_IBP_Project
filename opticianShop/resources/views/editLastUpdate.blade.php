...
@section('form')
<form action="{{ route('editLastUpdate.post') }}" method="post">
    @csrf
    <div class="card-body">
        <div class="form-group mb-3">
            <label for="tittle" class="form-label">Haber Başlığı:</label>
        ...
        <div class="form-group mb-3">
            <label for="content" class="form-label">Haber Metni:</label>
    ...
    <div class="card-footer text-end">
        <button type="submit" class="btn btn-warning">Haberi Güncelle
        </button>
    </div>
</form>
@endsection
